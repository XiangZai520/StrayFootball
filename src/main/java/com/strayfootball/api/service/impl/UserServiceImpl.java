...
public class UserServiceImpl extends BaseService implements UserService {
    ...
    public void edit(int userId, UserRequest request) {
        ...
        User model= User.builder().id(request.getId())
                .name(request.getName())
                .password(request.getPassword())
                .rolesId(request.getRolesId())
                .teamId(request.getTeamId())
        ...
        if(!StringUtil.isNullOrEmpty(request.getImage())){
    ...
    public LoginViewModel login(UserRequest request) {
        ...
        return LoginViewModel.builder().token(token).role(user.getRolesName()).account(user.getAccount()).image(user.getImage()).name(user.getName()).build();
    }
